...
export default class RankPanel extends Component {
    ...
    render() {
        return (
            <div className="rank">
                <div className="drawNo" style={{height:'45px', lineHeight:'45px', fontWeight:'bold', fontSize:'14pt'}}>{T.translate('lblDrawNo').toUpperCase() +' '+ this.state.drawNo}</div>
                <div className="top3">
                    <div className="pos">
                        <div className="info">
                            <div className={'num' + this.state.arrRes[0]} id="num">{this.state.arrRes[0]}</div>
                            <div className="idx">{T.translate('lbl1').toUpperCase()}</div>
                        </div>
                    ...
                    <div className="pos">
                        <div className="info">
                            ...
                            <div className="idx">{T.translate('lbl2').toUpperCase()}</div>
                        </div>
                    ...
                    <div className="pos">
                        <div className="info">
                            ...
                            <div className="idx">{T.translate('lbl3').toUpperCase()}</div>
                        </div>
